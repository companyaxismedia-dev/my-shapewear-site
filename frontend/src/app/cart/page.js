...
export default function CartPage() {
  // ⭐ Ensure context provides 'cart' or 'cartItems'
  ...
  if (!cart || cart.length === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="text-2xl sm:text-3xl font-black italic uppercase text-black">
          Your Cart is Empty
        </h1>
  ...
  return (
    <section className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6 py-10 sm:py-14 text-black">
