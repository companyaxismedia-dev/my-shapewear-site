...
export function PaymentDetailsPanel({
    ...
    const placeOrderBackend = async (
        ...
        if (orderPlaced) return false; // ⭐ ADD THIS
        try {
        ...
        const options = {
            ...
            handler: async function (response) {
                ...
                if (verifyData.success) {
                    ...
                    const orderId = await placeOrderBackend(type, addressId);
    ...
    const handlePaymentProcess = async (type) => {
        ...
        const orderId = await placeOrderBackend(
            type === "COD" ? "COD" : "CARD",
            addressId
        );
