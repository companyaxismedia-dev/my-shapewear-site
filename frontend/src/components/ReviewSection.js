...
const allReviews = [
  ...
  },
  {
    ...
    location: "Delhi",
    rating: 5,
    text: "Perfect fitting! Maine XL order kiya tha aur size chart ke hisaab se bilkul sahi aaya. Saree Imkaa ke liye ye market mein sabse best option hai. Pure cotton jaisa feel deta hai skin par.",
  ...
  },
  {
    ...
    location: "Pune",
    rating: 5,
    text: "Best for jeans and leggings. Gives a very natural curve and lift. Bahut saare Imkaa try kiye par ye wala meri body par best fit baithta hai. Confidence sach mein badh jata hai ise pehen kar.",
  ...
  },
  {
    ...
    location: "Kolkata",
    rating: 5,
    text: "Invisible lines! Maine ise ek bodycon dress ke niche pehna tha aur kisi ko pata bhi nahi chala ki andar Imkaa hai. Panty lines bilkul nahi dikhti. Kolkata ki garmi mein bhi comfortable hai.",
  ...
  },
  {
    ...
    location: "Hyderabad",
    rating: 5,
    text: "Saree look complete! Best Imkaa ever for heavy embroidery sarees. Ye weight ko achi tarah distribute kar deta hai aur back pain mein bhi thodi relief milti hai side support se.",
    isVideo: true,
    thumbnail: "/image/Reviews/WhatsApp Image 2026-01-19 at 14.22.09 (1).jpeg",
    videoUrl: "https://www.youtube.com/embed/MQLGVImRiko?autoplay=1"
  },
  ...
  return (
    <>
      <div className="flex justify-between items-center mb-6">
        ...
        <div className={`flex items-center gap-1.5 text-[10px] font-black px-4 py-2 rounded-full border uppercase tracking-widest ${isDark ? 'bg-white/10 text-green-400 border-white/10' : 'bg-green-50 text-green-700 border-green-100'
          }`}>
      ...
      <div className={`flex items-center gap-4 pt-6 border-t ${isDark ? 'border-white/10' : 'border-slate-100'}`}>
        <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg shadow-lg ${isDark ? 'bg-pink-600 text-white' : 'bg-[#041f41] text-white'
          }`}>
          {rev.name[0]}
        </div>
